...
horizon_jdbc_conn = java.sql.DriverManager.get_connection("jdbc:jtds:#{horizon_db["jdbcType"]}://#{horizon_db["host"]}:#{horizon_db["port"]}/#{horizon_db["db_name"]}", horizon_db["login"], horizon_db["password"])
